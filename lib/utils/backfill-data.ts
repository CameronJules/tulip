/**
 * Utility to backfill journal entries with realistic software developer content
 * Call from within the app (e.g., from a dev screen or console)
 */

import { format, subDays } from 'date-fns';
import { createJournalEntry, getJournalEntry } from '../models/journal-entry';
import { formatContent } from './date-helpers';
import type { MoodType } from '../models/types';
...
/**
 * Backfill journal entries with random data
 * Returns summary of created/skipped entries
 */
