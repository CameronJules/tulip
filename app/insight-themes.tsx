...
import ThemesIcon from '@/assets/images/insights/themes.svg';

export default function InsightThemesScreen() {
      ...
      <SafeAreaView style={[styles.safeArea, { backgroundColor }]}>
        <ScrollView style={styles.scrollView}>
          <ThemedView style={styles.content}>
            {/* Insight Image */}
            <ThemesIcon width={200} height={200} style={styles.insightImage} />
