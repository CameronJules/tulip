...
import MomentsIcon from '@/assets/images/insights/moments.svg';

export default function InsightMomentsScreen() {
      ...
      <SafeAreaView style={[styles.safeArea, { backgroundColor }]}>
        <ScrollView style={styles.scrollView}>
          <ThemedView style={styles.content}>
            {/* Insight Image */}
            <MomentsIcon width={200} height={200} style={styles.insightImage} />
